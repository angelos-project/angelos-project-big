...
class ExperimentDebugLarge {

    fun generateShortPositiveBigInt(): BigInt { return internalOf(intArrayOf(128, 0, 0, 0)) }
    ...
    fun generateLongPositiveBigInt(): BigInt { return internalOf(intArrayOf(1024, 0, 0, 0)) }
    fun generateLongPositiveBigInteger(): BigInteger {
        val bigInt = generateLongPositiveBigInt()
        return BigInteger(toByteArray(bigInt.mag, bigInt.sigNum))
    }
    fun generateShortNegativeBigInt(): BigInt { return internalOf(intArrayOf(-128, 0, 0, 0)) }
    fun generateShortNegativeBigInteger(): BigInteger {
        val bigInt = generateShortNegativeBigInt()
        return BigInteger(toByteArray(bigInt.mag, bigInt.sigNum))
    }
    fun generateLongNegativeBigInt(): BigInt { return internalOf(intArrayOf(-1024, 0, 0, 0)) }
